"use strict";
var MONTHS = ['January', 'February', 'March', 'April', 'Mayvv', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
var config1 = {
    type: 'line',
    data: {
        labels: ['January', 'February', 'March', 'April', 'Mayvv', 'June', 'July', 'August', 'September', 'October'],
        datasets: [{
...
var config2 = {
    type: 'line',
    data: {
        labels: ['January', 'February', 'March', 'April', 'Maygg', 'June', 'July'],
        datasets: [{
            label: 'My First dataset',
            backgroundColor: window.chartColors.red,
            borderColor: window.chartColors.red,
...
var barChartData1 = {
    labels: ['January', 'February', 'March', 'April', 'Maccy'],
    datasets: [{
        label: 'Raw Material',
...
var config5 = {
    type: 'line',
    data: {
        labels: ['January', 'February', 'March', 'April', 'Mahhhy', 'June', 'July'],
        datasets: [{
            label: 'My First dataset',
            backgroundColor: window.chartColors.red,
            borderColor: window.chartColors.red,
