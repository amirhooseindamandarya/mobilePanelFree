...
+function (t) {
    ...
    e.VERSION = "3.3.7", e.TRANSITION_DURATION = 150, e.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (h) {
                ...
                a = "bottom" == a && l.bottom + c > d.bottom ? "top" : "top" == a && l.top - c < d.top ? "bottom" : "right" == a && l.right + u > d.width ? "left" : "left" == a && l.left - u < d.left ? "right" : a, r.removeClass(f).addClass(a)
            }
            var _ = this.getCalculatedOffset(a, l, u, c);
            this.applyPlacement(_, a);
            var m = function () {
                var t = i.hoverState;
        ...
        var n = this.tip(), i = n[0].offsetWidth, r = n[0].offsetHeight, s = parseInt(n.css("margin-top"), 10),
        ...
        var u = /top|bottom/.test(o), c = u ? 2 * l.left - i + p : 2 * l.top - r + h,
            f = u ? "offsetWidth" : "offsetHeight";
        n.offset(e), this.replaceArrow(c, n[0][f], u)
        ...
        function n() {
            "in" != i.hoverState && r.detach(), i.$element && i.$element.removeAttr("aria-describedby").trigger("hidden.bs." + i.type), o && o()
        }
        ...
        var o = (e = e || this.$element)[0], n = "BODY" == o.tagName, i = o.getBoundingClientRect();
        null == i.width && (i = t.extend({}, i, {width: i.right - i.left, height: i.bottom - i.top}));
        var r = window.SVGElement && o instanceof window.SVGElement, s = n ? {top: 0, left: 0} : r ? null : e.offset(),
            a = {scroll: n ? document.documentElement.scrollTop || document.body.scrollTop : e.scrollTop()},
            p = n ? {width: t(window).width(), height: t(window).height()} : null;
    ...
    }, e.prototype.getViewportAdjustedDelta = function (t, e, o, n) {
        var i = {top: 0, left: 0};
    ...
    t.fn.tooltip = function (o) {
        return this.each(function () {
            var n = t(this), i = n.data("bs.tooltip"), r = "object" == typeof o && o;
            !i && /destroy|hide/.test(o) || (i || n.data("bs.tooltip", i = new e(this, r)), "string" == typeof o && i[o]())
        })
    ...
    t.fn.popover = function (o) {
        return this.each(function () {
            var n = t(this), i = n.data("bs.popover"), r = "object" == typeof o && o;
            !i && /destroy|hide/.test(o) || (i || n.data("bs.popover", i = new e(this, r)), "string" == typeof o && i[o]())
        })
...
!function (t, e) {
    ...
    return e = window.document, function () {
        ...
        return o.prototype.addSteps = function (t) {
            ...
            var i, r, s, a, p, h, l;
            if (a = o[0].offsetWidth, r = o[0].offsetHeight, l = o.offset(), p = l.left, h = l.top, (i = t(e).outerHeight() - l.top - o.outerHeight()) < 0 && (l.top = l.top + i), (s = t("html").outerWidth() - l.left - o.outerWidth()) < 0 && (l.left = l.left + s), l.top < 0 && (l.top = 0), l.left < 0 && (l.left = 0), o.offset(l), "bottom" === n.placement || "top" === n.placement) {
            ...
            var o, n, i, r, s, a, p, h;
            if (p = this.getStep(e), !(o = t(p.element)).length) return this._showPopoverAndOverlay(e);
            switch (n = t(window), s = o.offset().top, r = o.outerHeight(), h = n.height(), a = 0, p.placement) {
                case"top":
                    a = Math.max(0, s - h / 2);
                    break;
                case"left":
            ...
            return this._debug("Scroll into view. ScrollTop: " + a + ". Element offset: " + s + ". Window height: " + h + "."), i = 0, t("body, html").stop(!0, !0).animate({scrollTop: Math.ceil(a)}, function (t) {
                return function () {
            ...
            var i, r, s, a, p, h, l, u, c;
            for (s = t(e).height(), c = t(e).width(), u = [], a = 0, p = (l = ["top", "bottom", "left", "right"]).length; a < p; a++) switch (h = l[a], i = null != (r = this.backdrops)[h] ? r[h] : r[h] = t("<div>", {class: "tour-backdrop " + h}), t(o.backdropContainer).append(i), h) {
                case"top":
                    u.push(i.height(n.offset.top > 0 ? n.offset.top : 0).width(c).offset({top: 0, left: 0}));
                    break;
                case"bottom":
                    u.push(i.offset({
